...
impl ProblemDetails {
    ...
    pub fn validation_error(detail: impl Into<String>) -> Self {
        Self::new("about:blank", "Validation Error", 400).with_detail(detail)
    }

    /// Create an authentication error problem
    pub fn authentication_error() -> Self {
        Self::new("about:blank", "Authentication Required", 401)
    ...
    pub fn service_unavailable() -> Self {
        Self::new("about:blank", "Service Unavailable", 503)
    ...
    pub fn custom_problem(
        ...
        Self::new(problem_type, title, status)
    }
}
...
mod tests {
    ...
    fn test_problem_details_creation() {
        ...
        assert_eq!(
            problem.extensions.get("code"),
            Some(&serde_json::Value::String("TEST_001".to_string()))
        );
    }
