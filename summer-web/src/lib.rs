//! [![summer-rs](https://img.shields.io/github/stars/summer-rs/summer-rs)](https://summer-rs.github.io/docs/plugins/summer-web)
...
use summer::signal;
/////////////////web-macros/////////////////////
/// To use these Procedural Macros, you need to add `summer-web` dependency
...
///
/// ```rust,ignore
/// use summer_web::{Router, LayerConfigurator};
///
...
impl WebPlugin {
    async fn schedule(app: Arc<App>, config: ServerConfig) -> Result<String> {
        // 1. assemble final router (groups, layers, openapi, AppState, global prefix)
